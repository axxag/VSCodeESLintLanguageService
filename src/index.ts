...
import { EsLintConfigurationStatusBarWarning } from './warningStatusBar'

const typeScriptExtensionId = "vscode.typescript-language-features";
const pluginId = "typescript-eslint-plugin";
const configurationSection = "eslint-service";
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(new EsLintConfigurationStatusBarWarning());
